...
void PathTracePrimaryPass::BuildRayTracingSmokeTestScene(const viewDef_t* viewDef)
{
    ...
    bvhFrameTokenInput.staticActiveSetSignature = staticActiveSetPlan.activeSetSignature;
    bvhFrameTokenInput.staticResidentSetSignature = staticActiveSetPlan.residentSetSignature;
