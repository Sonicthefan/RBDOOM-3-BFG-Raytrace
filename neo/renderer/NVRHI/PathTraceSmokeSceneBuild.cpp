...
void PathTracePrimaryPass::BuildRayTracingSmokeTestScene(const viewDef_t* viewDef)
{
    ...
    const RtSmokeStaticBucketWorkPlan staticBucketWorkPlan =
        BuildSmokeStaticBucketWorkPlan(staticBucketWorkInput);
    ...
    bvhFrameTokenInput.materialGeneration = materialTableSignature;
    bvhFrameTokenInput.staticActiveSetSignature = staticBucketWorkPlan.activeSetPlan.activeSetSignature;
    bvhFrameTokenInput.staticResidentSetSignature = staticBucketWorkPlan.activeSetPlan.residentSetSignature;
    bvhFrameTokenInput.dynamicVertexCount = dynamicVertexCount;
    bvhFrameTokenInput.dynamicIndexCount = dynamicIndexCount;
    bvhFrameTokenInput.rigidRouteVertexCount = rigidRouteBuild.stats.vertices;
    bvhFrameTokenInput.rigidRouteIndexCount = rigidRouteBuild.stats.indexes;
    bvhFrameTokenInput.rigidRouteTriangleCount = rigidRouteBuild.stats.triangles;
    bvhFrameTokenInput.rigidRouteInstanceCount = rigidRouteBuild.stats.emittedInstances;
    bvhFrameTokenInput.rigidRouteSeenThisFrameCount = rigidRouteBuild.stats.emittedSeenThisFrame;
    bvhFrameTokenInput.rigidRouteCachedInstanceCount = rigidRouteBuild.stats.emittedFromCache;
    bvhFrameTokenInput.baseTlasInstanceCount = instanceCount - rigidTlasInstanceCount;
    bvhFrameTokenInput.rigidTlasInstanceCount = rigidTlasInstanceCount;
    bvhFrameTokenInput.hasStaticBlas = hasStaticBlas;
    bvhFrameTokenInput.hasDynamicBlas = hasDynamicBlas;
    const RtSmokeBvhFrameToken bvhFrameToken = BuildSmokeBvhFrameToken(bvhFrameTokenInput);
    ...
    bvhDirtyInput.current = bvhFrameToken.dirtyToken;
