...
void RayGen()
{
    ...
    if (payload.value == 0)
    {
        ...
        else if (debugMode == 18 || debugMode == 19 || debugMode == 20 || debugMode == 25 || debugMode == 38 || debugMode == 39 || debugMode == 40 || debugMode == 41 || debugMode == 42 || (debugMode >= 34 && debugMode <= 37))
        {
            SmokeOutput[pixel] = float4(0.0, 0.0, 0.0, 1.0);
        }
